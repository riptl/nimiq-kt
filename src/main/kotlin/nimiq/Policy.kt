...
object Policy {
    ...
    const val DIFFICULTY_BLOCK_WINDOW = 120
    const val DIFFICULTY_MAX_ADJUSTMENT_FACTOR = 2
    const val TRANSACTION_VALIDITY_WINDOW = 120
    const val SATOSHIS_PER_COIN = 100000
    const val TOTAL_SUPPLY: Satoshi = 2100000000000000
    const val INITIAL_SUPPLY: Satoshi = 252000000000000
