...
object GenesisConfig {
    ...
    fun test() {
        ...
        seedPeers = arrayListOf(
            ...
            WssPeerAddress.seed("seed2.nimiqtest.net", 8080, "03feec9d5316a7b5ebb69c4e709547a28afe8e9ef91ee568df489d29e9845bb8")
            WssPeerAddress.seed("seed2.nimiqtest.net", 8080, "943d5669226d3716a830371d99143af98bbaf84c630db24bdd67e55ccb7a9011")
        )
        seedLists = arrayListOf()
        genesisBlock = Block(
            BlockHeader(
